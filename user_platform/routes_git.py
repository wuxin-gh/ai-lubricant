...
Mirrors the upstream git handler contract for identities and bots. Access
...
identity_router = APIRouter(
    prefix="/api/v1/users/git-identities", tags=["user-platform-git-identities"]
)
bot_router = APIRouter(prefix="/api/v1/users/git-bots", tags=["user-platform-git-bots"])
