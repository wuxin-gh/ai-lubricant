...
class WebhookService:
    ...
    async def enable_webhook(
        ...
        *,
        ...
        logger.info(
            "[user-platform] webhook enabled: project={} platform={} hook_id={}",
    ...
    async def resync_callback(
        ...
        *,
        ...
        logger.info(
            "[user-platform] webhook callback resynced: project={} url={}",
            project.id, new_url,
        )
        return _webhook_dict(row)
        ...
        if resolved is not None:
            ...
            try:
                ...
                if "HTTP 404" not in str(exc):
                    logger.warning(
                        "[user-platform] webhook delete failed: project={} error={}",
                        project.id, exc,
                    )
        await row.delete()
        return True
