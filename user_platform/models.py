...
#
# These tables back the upstream user-facing platform. They are fully
...
# upstream ent schema so ported handlers behave identically.
#
...
class User(Model):
    ...
    # bcrypt hash (passlib), byte-compatible with upstream's crypto.HashPassword.
