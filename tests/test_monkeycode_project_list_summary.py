...
async def test_list_projects_enriches_creator_requirement_and_task_counts(db):
    from monkeycode_compat.models_project import ProjectIssue
...
async def test_list_projects_normal_user_scoped_to_owned_and_collab(db):
    from monkeycode_compat.models_project import ProjectCollaborator
    from monkeycode_compat.project_service import project_service
...
async def test_route_adds_editor_count_from_bulk_summaries(db, monkeypatch):
    ...
    from monkeycode_compat import routes_project
    from monkeycode_compat.models import User
    from monkeycode_compat.models_project import Project
