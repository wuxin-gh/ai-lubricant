...
# matching the MonkeyCode route groups.
skill_router = APIRouter(prefix="/api/v1/skills", tags=["monkeycode-skills"])
plugin_router = APIRouter(prefix="/api/v1/plugins", tags=["monkeycode-plugins"])
