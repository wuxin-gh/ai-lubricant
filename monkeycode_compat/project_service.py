...
collaborator role, mirroring the MonkeyCode contract.
    ...
    async def scan_stack_profile(self, project_id: str) -> dict | None:
        ...
        **绝不抛**（调用方是 fire-and-forget 任务/同步重扫路由）：上游失败只
        ...
        try:
            ...
            await project.save(update_fields=["stack_profile"])
            logger.warning(
                "[monkeycode-compat] stack scan tree failed: platform={} full_name={} project_id={} error={}",
    ...
    async def _scan_submodules(
        ...
        *,
        ...
        try:
            ...
            logger.warning(
                "[monkeycode-compat] stack scan .gitmodules failed: platform={} project_id={} error={}",
    ...
    async def get_tree(
        ...
        *,
        ...
        try:
            ...
            logger.warning(
                "[monkeycode-compat] get tree failed: platform={} full_name={} project_id={} error={}",
                platform,
                full_name,
                project.id,
                exc,
    ...
    async def get_blob(
        ...
        *,
        ...
        try:
            ...
            logger.warning(
                "[monkeycode-compat] get blob failed: platform={} full_name={} project_id= error={}",
                platform,
                full_name,
                project.id,
                exc,
    ...
    async def _resolve_submodule_map(
        ...
        *,
        ...
        try:
            ...
            logger.warning(
                "[monkeycode-compat] fetch .gitmodules failed: platform={} project_id={} error={}",
                platform,
                project.id,
                exc,
            )
