"""Environment-driven configuration for the optional MonkeyCode compatibility layer."""
...
class MonkeyCodeCompatSettings:
    enabled: bool
    database_url: str
...
def load_settings() -> MonkeyCodeCompatSettings:
    ...
    return MonkeyCodeCompatSettings(
...
def reload_settings() -> MonkeyCodeCompatSettings:
