...
The vendored MonkeyCode frontend (mobile + console data-provider) calls these
...
models_router = APIRouter(prefix="/api/v1/users/models", tags=["monkeycode-user-models"])
